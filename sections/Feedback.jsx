  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div 
        ...
        className='flex-[0.5] lg:ma-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative'
      >
      ...
      >
        <img 
          src='./planet-09.png'
          alt='planet-09'
          className='w-full lg:h-[610px] h-auto min-h-[210px] objet-cover rounded-[40px]'
        />
